...
\title{Physik V\\ -\\Hochenergie- und Kernphysik\\-\\ Klausur (1. Versuch WiSe 2014/15) }
\date{02.02.2015}
\author{P. Schleper}
...
Jede Aufgabe 20 Punkte, also insgesamt 120 Punkte.\\
\newline
Vorne angeheftet waren die beiden Tabellen aus dem Script S.11/12 (Teilchensorten + Massen UND Hadronen + Massen).\\
Hilfsmittel: 2 doppelseitig beschriebene A4-Blätter, einfacher Taschenrechner.\\
\\
Dies ist ein Gedächnissprotokoll, daher sind die Aufgabenstellungen nicht 1zu1!\\

\section{Verständnisfragen}
\subsection{} In einem Proton sind auch Antiquarks. Wie kann das sein und warum tragen diese nicht zu den Quantenzahlen des Protons bei?
\subsection{} Nenne (mindestens) zwei Prozesse an denen man die Notwendigkeit der drei Quarkfarben sieht.
\subsection{} Woher kann man wissen, dass es nur drei Neutrinos gibt?
...
\subsection{}  Im PEP werden aus $e^+ e^-$-Kollisionen $b\bar{b} = \Upsilon$-Systeme erzeugt. Die Masse dises Systems ist $M=10,58 GeV$ und die Energie des Elektron-Strahls liegt bei $3,1 GeV$. Welche Energie muss der Positron-Strahl haben, um ein $\Upsilon$ zu erzeugen. Verwenden Sie eine gut Näherung!
...
\subsection{} Vergleichen Sie die Matrixelemente für den Zerfall in Quarks und den für Fermionen. Wie viel \% der Zerfälle erwarten Sie nur Leptonen im Endzustand?
